      ...
      <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
        ...
        <div class="grid grid-cols-2 gap-4 text-slate-50">
          ...
          <div class="z-[25] grid grid-cols-2 content-end gap-1 p-3">
            <button
              type="button"
              class="rounded-lg bg-gradient-to-br from-purple-600 to-blue-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800"
            >
              Ver ahora
            </button>
            ...
            <button
              type="button"
              class="rounded-lg bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 px-5 py-2.5 text-center text-sm font-medium text-gray-900 hover:bg-gradient-to-bl focus:outline-none focus:ring-4 focus:ring-red-100 dark:focus:ring-red-400"
            >
              Descargar
            </button>
          </div>
